...
<CodebaseSnippet filePath="packages/backend/src/router.ts" lineStart="23" lineEnd="51">
...
<CodebaseSnippet filePath="packages/platform/app/account/layout.tsx" lineStart="10" lineEnd="29">
